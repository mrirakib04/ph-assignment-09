...
const Footer = () => {
  return (
    <div className="w-full bg-linear-to-br from-black via-black to-sky-950 py-10 sm:px-8 px-5 flex flex-col items-center">
      <div className="flex flex-wrap justify-between items-start gap-5 w-full py-5 border-b border-gray-500">
        <div className="flex flex-col items-start gap-3">
          <h4 className="text-2xl font-bold text-white">SkillSwap</h4>
          <p className="max-w-xs font-medium text-gray-300">
            SkillSwap is a modern skill development and sharing platform
            designed to connect learners and creators. Our goal is to help
            people exchange knowledge, learn new skills, and grow together
            through practical, community-driven learning experiences.
          </p>
        </div>
        <div className="flex flex-col items-start gap-3">
