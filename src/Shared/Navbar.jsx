        ...
        <div className="text-black flex justify-between items-center py-4 md:px-6 sm:px-3 px-2 mx-auto shadow-md">
          <div className="relative text-xl flex gap-3 font-bold items-center">
            ...
            <Link to={"/"} className="group flex items-center gap-1">
              <img
                className="sm:w-10 w-8 border-b-2 border-l-2 border-black rounded-tl-lg rounded-br-lg group-hover:border-cyan-700 duration-300 group-hover:scale-105"
                src={logo}
                alt="logo"
              />
          ...
          {user ? (
            <div className="relative">
              <button onClick={profileShowHide}>
                <img
                  className="h-12 w-12 object-cover rounded-full border-2 border-sky-700 cursor-pointer hover:scale-105 duration-300 transition"
                  src={userImage}
                  alt="User-Photo"
                />
              </button>
